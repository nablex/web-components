<template id="n-form-qr">
	<div class="n-form-qr n-form-component" :class="{'n-form-qr-scanned': scanned}">
		...
		<div class="n-form-qr-container">
			<div class="n-form-canvas-container">
				...
				<div ref="overlay" class="overlay" v-show="!scanning"
					...
					<button class="n-form-qr-retry" @click="rescan">
		...
		<n-form-text ref="text" v-model="code" :label="manualLabel" :placeholder="manualPlaceholder" @input="checkEmpty"
			:required="required" :schema="schema" :placeholder="placeholder" :validator="validator" :edit="edit" />
	</div>
</template>