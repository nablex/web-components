<template id="n-form-checkbox">
	<div class="n-form-component n-form-checkbox" :class="{ 'n-form-hidden': hide, 'n-form-disabled': disabled }" :optional="hide != null">
		...
		<input ref="input" @click="toggleValue()" type="checkbox" v-checked="value" :disabled="!edit || disabled" :value="value" v-if="!hide" :class="{ 'n-form-required': mandatory, 'n-form-optional': !mandatory, 'n-form-valid': valid != null && valid, 'n-form-invalid': valid != null && !valid }" class="n-form-checkbox-input"/>
